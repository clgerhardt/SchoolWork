...
public class ShapeGenerator extends Application {
	...
	public void start(Stage primaryStage) {
		...
		primaryStage.setTitle("HW 7 - Problem 1");
		primaryStage.show();
	}
	...
	private void readShapesFile(File file) throws FileNotFoundException {
		...
		File inFile = new File("src/prob1/shapes.txt");
	...
	private void writeShapesFile(File file) throws FileNotFoundException {
		...
		File outFile = new File("src/prob1/newshapes.txt");

		try {
			PrintWriter writer = new PrintWriter(outFile);
			for (GeometricObject e : shapes) {
				if (e instanceof Triangle) {
					Triangle e2 = ((Triangle) e);
					writer.print(e2.toString2() + " \n");
				}
